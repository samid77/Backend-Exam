...
class Transfer extends Component {
  ...
  transferDana = (e) => {
    axios.post(`http://localhost:8002/transferdana`, {
        rekeningtujuan: e.rekeningtujuan.value,
        nominaltransfer: e.nominaltransfer.value,
        ...
        <div className="content-wrapper">
            ...
            <div className="box box-primary">
                <div className="box-header with-border">
                    <h3 className="box-title">Transfer Dana</h3>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <input type="text" ref="rekeningtujuan" className="form-control" placeholder="Masukan nomor rekening yang dituju"/>
                            </div>
                            {/* /.form-group */}
                            <div className="form-group">
                                <label>Nominal Transfer</label>
                                <input type="text" ref="nominaltransfer" className="form-control" placeholder="Masukan nominal yang ingin di transfer"/>
                            </div>
                            <div className="form-group">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="form-group">
                                ...
                                <div className="alert alert-success alert-dismissible">
                                    ...
                                    <h4><i className="icon fa fa-check"></i> Transfer Berhasil!</h4>
                                    Transaksi telah berhasil dilakukan.
                                </div>
                            </div>
                            {/* /.form-group */}
                            <div className="form-group">
                                <button type="button" onClick={() => this.transferDana(this.refs)} className="btn btn-danger btn-flat btn-md "><i className="fa fa-paper-plane"></i> Transfer</button>
                            </div>
                        </div>
                        {/* /.col */}
                        </form>
